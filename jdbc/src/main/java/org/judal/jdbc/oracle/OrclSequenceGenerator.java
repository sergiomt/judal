...
public class OrclSequenceGenerator implements Sequence {

	private JDBCDataSource dataSource;
	private String sequenceName;
	private long current;
	
	public OrclSequenceGenerator(JDBCDataSource dataSource, String sequenceName) {
	...
	public long nextValue() throws JDOException {
        ...
        try {
	        ...
	        rset = stmt.executeQuery("SELECT " + getName() + ".NEXTVAL FROM dual");
	        rset.next();
