...
public class WritableComparator implements RawComparator {
  ...
  public WritableComparable newKey()
  	...
  	final Class<?>[] EMPTY_ARRAY = new Class[]{};
  	Constructor meth = keyClass.getDeclaredConstructor(EMPTY_ARRAY);
    meth.setAccessible(true);
    WritableComparable retval;
    try {
      retval = (WritableComparable) meth.newInstance();
  ...
  /** 
   * <p>Read the data into two {@link WritableComparable}s (using {@link Writable#readFields(DataInput)}, then calls {@link #compare(WritableComparable,WritableComparable)}.
   */
